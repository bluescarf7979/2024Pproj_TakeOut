...
# 관리자 로그인 정보
admin_credentials = {
    "username": "AAA",  # 관리자 계정 사용자명
    "password": "AAA"  # 관리자 계정 비밀번호
}
...
if response.status_code == 200:
    ...
    print("로그인 실패:", response.status_code, response.json())

USER_LIST_URL = "http://127.0.0.1:8000/api/road_info/"
...
if response.status_code == 200:
    ...
    print("사용자 목록 조회 실패:", response.status_code)